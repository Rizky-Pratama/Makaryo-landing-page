...
function Testimoni() {
  return (
    <section className="h-max bg-primary">
      <div className="mx-auto max-w-screen-2xl">
        <div className="container">
          <div className="pt-32 flex flex-col gap-16 items-center">
            <h2 className="w-[35rem] text-4xl font-bold text-white text-center">
              We are extremely satisfied with Makaryo's products
            </h2>
            <div className="h-[300vh] columns-3">
              <CardTestimoni
                profile="1"
                name="Terry Torff"
                position="Sr. Product Designer"
                desk="Makaryo's job search platform is the best I've ever used, it's easy and
        quick in finding my dream job!"
              />
              <CardTestimoni
                profile="2"
                name="Jordyn Donin"
